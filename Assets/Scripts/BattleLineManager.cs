...
public class BattleLineManager : MonoBehaviour
{
    ...
    private Dictionary<int, string> playerLines = new Dictionary<int, string>
    {
        ...
        { 10, "I’m surprised you’re even here\nafter years of being dusted/You’re tired and old, I doubt you’re well-adjusted"},
        { 11, "I’m surprised you’re even here\nafter years of being dusted/Look at all those dust mites, ewww, gross"},
        ...
        { 42, "I don’t need arms to beat you,\nI can just use my words/Spittin’ fire so fast\nI’m like a dragon from lore"},
